...
//        _titleSelectColor=SFQRedColor;
        _titleSelectColor = UIColorGromRGBV(38, 180, 99);
        ...
        _selectLine=[[UIView alloc] initWithFrame:CGRectMake(10, self.frame.size.height-2, _btn_w - 20, 2)];
        ...
        for (int i=0; i<titleArray.count; i++) {
            ...
            //            [btn setBackgroundImage:[UIImage imageNamed:@"unsel"] forState:UIControlStateNormal];
            //            [btn setBackgroundImage:[UIImage imageNamed:@"sel"] forState:UIControlStateSelected];
...
-(void)btnClick:(UIButton *)btn{
    ...
    [UIView animateWithDuration:0.2 animations:^{
        ...
        _selectLine.frame=CGRectMake(btn.frame.origin.x+10, self.frame.size.height-2, btn.frame.size.width-20, 2);
